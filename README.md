...
The composition-disjoint number is the honest generalisation estimate. Degradation is modest (~29% on MAE), which indicates the model learned genuine structure–property signal rather than composition lookup. Both are reported because the gap is itself the measurement.
